const Loading = () => {
  ...
  return (
    <div className="m-auto w-screen center mt-[20vh]">
      <div className="center space-x-[0.5vw] bg-stone-800 px-[1vw] py-[1vh] rounded-ease drop-shadow-2xl">
        <svg
          ...
          height="3vw"
          viewBox="0 0 30 30"
          className="animate-spin fill-stone-200"
        >
        ...
        <p className="text-plain text-stone-200 font-medium">{randomMessage}</p>
      </div>
    </div>
  );
};
